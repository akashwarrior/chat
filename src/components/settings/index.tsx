    ...
    <main className="flex-1 px-4 py-8 lg:p-8 max-w-4xl">
      ...
      <Tabs value={tab} onValueChange={handleTabChange}>
        ...
        <TabsContent value="contact">
          <h2 className="text-xl lg:text-2xl font-semibold mb-2">Contact Us</h2>
          ...
          <div className="flex gap-1 text-muted-foreground">
            <a
              ...
              className="flex items-center gap-1.5 text-sm font-medium px-2 py-1 cursor-pointer hover:underline underline-offset-3 focus-visible:underline"
            >
              <svg
                viewBox="0 0 1200 1227"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="size-3 shrink-0 select-none"
              >
                <path
                  fill="currentColor"
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://github.com/akashwarrior/chat"
              className="flex items-center gap-1.5 text-sm font-medium px-2 py-1 cursor-pointer hover:underline underline-offset-3 focus-visible:underline"
            >
              <svg
